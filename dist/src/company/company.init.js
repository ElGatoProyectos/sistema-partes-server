...
companyRouter.get(`${prefix}/file/:id`, company_middleware_1.companyMiddleware.verifyHeadersFields, auth_role_middleware_1.authRoleMiddleware.authAdminUser, company_controller_1.companyController.findImage);
companyRouter.get(`${prefix}/:id`, company_middleware_1.companyMiddleware.verifyHeadersFields, auth_role_middleware_1.authRoleMiddleware.authAdminUser, company_controller_1.companyController.findByIdCompany);
