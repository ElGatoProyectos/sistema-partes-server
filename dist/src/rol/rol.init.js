...
rolRouter.get(`${prefix}/:id`, rol_middleware_1.rolMiddleware.verifyHeadersFields, auth_role_middleware_1.authRoleMiddleware.authAdminAndProjectManagerAndUser, rol_controller_1.rolController.findByIdRol);
rolRouter.get(`${prefix}`, auth_role_middleware_1.authRoleMiddleware.authViewAll, rol_controller_1.rolController.allRoles);
