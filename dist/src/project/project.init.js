...
projectRouter.get(`${prefix}/:id`, auth_role_middleware_1.authRoleMiddleware.authAdminAndGeneralProjectAndCostControlAndUser, project_middleware_1.projectMiddleware.verifyHeadersFields, project_controller_1.projectController.findByIdProject);
...
projectRouter.patch(`${prefix}/:id`, project_middleware_1.projectMiddleware.verifyHeadersFields, project_middleware_1.projectMiddleware.verifyFieldsUpdateState, auth_role_middleware_1.authRoleMiddleware.authAdminAndGeneralProjectAndCostControlAndUser, project_controller_1.projectController.updateState);
projectRouter.delete(`${prefix}/:id`, auth_role_middleware_1.authRoleMiddleware.authAdminAndGeneralProjectAndCostControlAndUser, project_middleware_1.projectMiddleware.verifyHeadersFields, project_controller_1.projectController.updateStatus);
