...
class ProductionUnitService {
    createProductionUnit(data, project_id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const formattedCodigo = yield this.getNextProductionUnitCode();
    ...
    getNextProductionUnitCode() {
        return __awaiter(this, void 0, void 0, function* () {
            const lastProductionUnit = yield productionUnit_validation_1.productionUnitValidation.codeMoreHigh();
    ...
    findAll(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const skip = (data.queryParams.page - 1) * data.queryParams.limit;
                const result = yield prisma_production_unit_repository_1.prismaProductionUnitRepository.findAllPagination(skip, data.queryParams.limit);
                const { productionUnits, total } = result;
                const pageCount = Math.ceil(total / data.queryParams.limit);
                const formData = {
                    total,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield Promise.all(sheetToJson.map((item) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!validator_1.default.isNumeric(item.CODIGO)) {
                ...
                let productionUnit;
                yield Promise.all(sheetToJson.map((item) => __awaiter(this, void 0, void 0, function* () {
                    code = yield productionUnit_validation_1.productionUnitValidation.findByCode(String(item.CODIGO));
                    if (!code.success) {
