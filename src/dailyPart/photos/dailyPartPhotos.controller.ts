...
import { dailyPartPhotoService } from "./dailyPartPhotos.service";
import { photosDto } from "./dto/photo.dto";
import { I_CreateDetailPhotosBody } from "./models/dailyPart.interface";
...
class DailyPartPhotosController {
        ...
        if (!validator.isNumeric(daily_part_id)) {
          ...
          try {
            ...
            if (!responseValidate?.success) {
              ...
              photosDto.parse(request.body);
              const data = request.body as I_CreateDetailPhotosBody;
              ...
              const result =
                await dailyPartPhotoService.updateDetailDailyPartPhoto(
                  data,
                  +daily_part_id
                );
              if (!result.success) {
                ...
                if (
                  ...
                  if (fileOne) {
                    ...
                    const fileNameOne = `${daily_part_id}_photo_1.png`;
                ...
                if (
                  ...
                  if (fileTwo) {
                    ...
                    const fileNameTwo = `${daily_part_id}_photo_2.png`;
                ...
                if (
                  ...
                  if (fileThree) {
                    ...
                    const fileNameThree = `${daily_part_id}_photo_3.png`;
                    const filePathThree = path.join(
                      directionTwo,
                      fileNameThree
                    );
                ...
                if (
                  ...
                  if (fileFour) {
                    ...
                    const fileNameFour = `${daily_part_id}_photo_4.png`;
  ...
  findImage = async (request: express.Request, response: express.Response) => {
    ...
    const dailyPartResponse = await dailyPartPhotoService.findIdImage(
      +daily_part_id,
      +number
    );
