...
import { originDto } from "./dto/originWorkforce.dto";

class OriginWorkforceMiddleware {
  verifyFields(
...
export const originWorkforceMiddleware = new OriginWorkforceMiddleware();
