...
import { assistsDto } from "./dto/assists.dto";

class AssistsWorkforceMiddleware {
  verifyFields(
...
export const assistsWorkforceMiddleware = new AssistsWorkforceMiddleware();
