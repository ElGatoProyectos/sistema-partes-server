...
import { typeDto } from "./dto/typeWorkforce.dto";

class TypeWorkforceMiddleware {
  verifyFields(
...
export const typeWorkforceMiddleware = new TypeWorkforceMiddleware();
